  ...
  return (
    <div className="container-page py-10 space-y-10">
      <header className="text-center">
        ...
        <p className="text-brand-gray-dark mt-2">
        ...
        <p className="text-brand-gray-dark mt-2">{t("method")}</p>
      </header>
      ...
      <section className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {GARMENTS.map((garment) => (
          ...
          >
            {garment.image && (
              <div className="relative w-full aspect-[4/5] bg-gradient-to-br from-brand-gray-lighter to-brand-gray-light/30 overflow-hidden">
                <img
                  src={garment.image}
                ...
                />
                {garment.audience && (
                  <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-medium text-brand-gray-dark shadow-sm">
            ...
            <div className="p-6 flex flex-col flex-1 bg-white">
              <div className="mb-4">
                <h2 className="font-bold text-xl text-brand-black mb-2 line-clamp-2">
              ...
              <div className="mb-4 p-4 bg-brand-gray-lighter rounded-lg border border-brand-gray-light/50">
                ...
                <ul className="space-y-2">
                  {garment.prices.map((p) => (
                    ...
                    >
                      <span className="text-brand-gray-dark flex-1 mr-2">
                        {isFr ? p.labelFr : p.labelEn}
                      </span>
                      <span className="font-bold text-brand-black text-base whitespace-nowrap">
                        {p.price}
                      </span>
                    </li>
                  ))}
              ...
              <div className="mt-auto pt-4 border-t border-brand-gray-light/50">
                {(() => {
